...
inThisBuild(
  List(
    ...
    scmInfo := Some(
      ScmInfo(url("https://github.com/zio/zio-lmdb/"), "scm:git:git@github.com:zio/zio-lmdb.git")
    )
  )
)
...
lazy val zioLmdb = crossProject(JSPlatform, JVMPlatform)
  .in(file("zio-lmdb"))
  .settings(stdSettings("zioLmdb"))
  .settings(crossProjectSettings)
  .settings(buildInfoSettings("zio.lmdb"))
  .settings(
